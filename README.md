...
<button id="musicToggle" class="music-btn" aria-label="Activar música">♪</button>
<audio id="music" preload="auto">
  <!-- Cambia por tu archivo local o URL pública -->
  <source src="assets/audio/Audios/Iframe I Wanna Be Yours [nyuo9-OjNNg].mp3" type="audio/mpeg" />
</audio>
...
<section class="card hidden" id="initial">
  <!-- Cambia por tu imagen local/URL -->
